...
const localeLoaders = {
  de: () => import("./locales/de.js?v=20260713-quality5"),
  en: () => import("./locales/en.js?v=20260713-quality5"),
  es: () => import("./locales/es.js?v=20260713-quality5"),
  ja: () => import("./locales/ja.js?v=20260713-quality5")
};
