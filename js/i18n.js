...
const localeLoaders = {
  de: () => import("./locales/de.js?v=20260713-quality11"),
  en: () => import("./locales/en.js?v=20260713-quality11"),
  es: () => import("./locales/es.js?v=20260713-quality11"),
  ja: () => import("./locales/ja.js?v=20260713-quality11")
};
