...
const localeLoaders = {
  de: () => import("./locales/de.js?v=20260713-quality12"),
  en: () => import("./locales/en.js?v=20260713-quality12"),
  es: () => import("./locales/es.js?v=20260713-quality12"),
  ja: () => import("./locales/ja.js?v=20260713-quality12")
};
