...
const PRECACHE_ASSETS = [
  ...
  "./style.css?v=20260706-pdffill1",
  "./app.js?v=20260706-pdffill1",
  "./manifest.webmanifest?v=20260706-pdffill1",
  "./image/pwa/favicon-32.png?v=20260706-pdffill1",
  "./image/pwa/favicon-48.png?v=20260706-pdffill1",
  "./image/profile-avatar.jpg?v=20260706-pdffill1",
  ...
  "./image/pwa/icon-512.png?v=20260706-pdffill1",
  "./image/pwa/maskable-192.png?v=20260706-pdffill1",
  "./image/pwa/maskable-512.png?v=20260706-pdffill1",
  "./image/pwa/apple-touch-icon.png?v=20260706-pdffill1",
