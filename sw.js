const PK_PORTFOLIO_CACHE = "pk-portfolio-cache-20260703-pwa1";
...
const PRECACHE_ASSETS = [
  ...
  "./style.css?v=20260703-pwa1",
  "./app.js?v=20260703-pwa1",
  "./manifest.webmanifest",
  "./image/iconstar.gif",
  "./image/profile-avatar.jpg?v=20260703-pwa1",
  "./image/iconic-720.jpg?v=20260616-1",
  "./image/iconic-960.jpg?v=20260616-1",
  "./image/iconic.jpg?v=20260616-1",
  "./image/iconic-avatar-720.jpg?v=20260703-pwa1",
  "./image/iconic-avatar-960.jpg?v=20260703-pwa1",
  "./image/iconic-avatar.jpg?v=20260703-pwa1",
  "./image/social-card.jpg?v=20260703-pwa1",
  "./image/no_signal.jpg?v=20260616-1",
  "./image/pwa/icon-192.png?v=20260703-pwa1",
  "./image/pwa/icon-512.png?v=20260703-pwa1",
  "./image/pwa/maskable-192.png?v=20260703-pwa1",
  "./image/pwa/maskable-512.png?v=20260703-pwa1",
  "./image/pwa/apple-touch-icon.png?v=20260703-pwa1",
