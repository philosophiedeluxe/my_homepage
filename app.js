(function () {
  ...
  const translations = {
    de: {
      ...
      "vita.decision.fit1.label": "Best Fit",
      "vita.decision.fit1.value": "APEX Developer · Business Apps",
      "vita.decision.fit2.label": "Stärke",
      "vita.decision.fit2.value": "Prozessdenken + Datenmodelle",
      "vita.decision.fit3.label": "Bonus",
      "vita.decision.fit3.value": "Delivery, ITIL & Projektverständnis",
      ...
      "vita.trust.step3": "Scrum Master & Product Owner",
      "vita.trust.step4": "PRINCE2 / ITIL",
    ...
    en: {
      ...
      "vita.decision.fit1.label": "Best fit",
      "vita.decision.fit1.value": "APEX Developer · Business Apps",
      "vita.decision.fit2.label": "Strength",
      "vita.decision.fit2.value": "Process thinking + data models",
      "vita.decision.fit3.label": "Bonus",
      "vita.decision.fit3.value": "Delivery, ITIL & project understanding",
      "vita.evolution.eyebrow": "Skill evolution",
    ...
    es: {
      ...
      "vita.decision.fit1.label": "Best fit",
      "vita.decision.fit1.value": "APEX Developer · Business Apps",
      "vita.decision.fit2.label": "Fortaleza",
      "vita.decision.fit2.value": "Procesos + modelos de datos",
      "vita.decision.fit3.label": "Bonus",
      "vita.decision.fit3.value": "Delivery, ITIL y visión de proyecto",
    ...
    ja: {
      ...
      "vita.decision.fit1.label": "Best Fit",
      "vita.decision.fit1.value": "APEX Developer · Business Apps",
      "vita.decision.fit2.label": "強み",
      "vita.decision.fit2.value": "プロセス思考 + データモデル",
      "vita.decision.fit3.label": "Bonus",
      "vita.decision.fit3.value": "Delivery、ITIL、プロジェクト理解",
      "vita.evolution.eyebrow": "Skill Evolution",
  ...
  function setupScrollReveals() {
    ...
    addReveal(".system-profile-panel, .stack-console, .skill-graph, .vita-decision-console, .trust-chain-panel, .certificate-header > div", "up");
    addReveal(".section-heading, .page-hero > *, .legal-page > section, .legal-page > .legal-note", "up");
    addReveal(".project-card, .stack-grid article, .profile-grid article, .skill-evolution-node, .trust-chain-steps span, .timeline-playback, .timeline-item, .credential-list li, .oracle-badge-card, .proof-card", "up", true);
  ...
  function setupHeroAvatarEgg() {
    const avatarSources = {
      src: "./image/iconic-avatar.jpg?v=20260703-vitaexperience1",
      srcset: "./image/iconic-avatar-720.jpg?v=20260703-vitaexperience1 720w, ./image/iconic-avatar-960.jpg?v=20260703-vitaexperience1 960w, ./image/iconic-avatar.jpg?v=20260703-vitaexperience1 1122w",
